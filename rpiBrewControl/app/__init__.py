...
manager.create_api(Sensor, methods=['GET', 'POST', 'PATCH'],max_results_per_page=20,collection_name='sensors', exclude_columns=['readings','setpoints'],allow_patch_many=True,primary_key='sensor_id')
